...
function sc_render_login_form_social_connect($no_args, $display_label=true) {
...
add_action('login_form', 'sc_render_login_form_social_connect', null, 2);
add_action('register_form', 'sc_render_login_form_social_connect', null, 2);
add_action('after_signup_form', 'sc_render_login_form_social_connect', null, 2);
...
class SocialConnectWidget extends WP_Widget {
	...
	function SocialConnectWidget() {
		parent::WP_Widget(
			...
			array('description' => __('Adds functionality to connect with Facebook, Twitter, Yahoo, Google or Wordpress.com account', 'social_connect'))
		);
	}
	...
	function widget($args, $instance) {
		...
		sc_render_login_form_social_connect(null, false);
	...
	function form($instance) {
		...
		$before_widget_content = esc_attr($instance['before_widget_content']);
		$after_widget_content = esc_attr($instance['after_widget_content']);
		?>
		<p>
			...
			<input class="widefat" id="<?php echo $this->get_field_id('before_widget_content'); ?>" name="<?php echo $this->get_field_name('before_widget_content'); ?>" type="text" value="<?php echo $before_widget_content; ?>" />
			<label for="<?php echo $this->get_field_id('after_widget_content'); ?>"><?php _e('After widget content:', 'social_connect'); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id('after_widget_content'); ?>" name="<?php echo $this->get_field_name('after_widget_content'); ?>" type="text" value="<?php echo $after_widget_content; ?>" />
		</p>
		<?php
	}

} // end of class SocialConnectWidget
